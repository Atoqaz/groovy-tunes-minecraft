...
pling += (
    ".C,C,GCE.C.fA#D.A#.--C,C,C,C,dfA#.C.-.C,C,GCE.C.fA#D.A#.--C,C,C,C,dfA#.D.fAC.C,C, "
)
pling += (
    "GD#.C.D#-dfA#-cfA.C,A#,GC.C.C-dfA#-cfA-gc.gc.-dfA#-cfA-gc.gc.-dfA#.dfA#.cfA.C,C, "
)
pling += (
    "GD#.C.D#-dfA#-cfA.C,A#,GC.C.C-dfA#-cfA-gc.gc.-fA#D-fAC-gc.gc.-fA#D.fA#D.fAC.G. "
)
